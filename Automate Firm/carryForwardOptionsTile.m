...
@implementation carryForwardOptionsTile
...
//        self.tileIdString=[myappde.advanceTileIdDict objectForKey:self.tagString];
...
//                                                   self.startsClosed=YES;
//                                                   myappde.addnewCount=myappde.addnewCount-1;
//                                                   if (!(self.tileIdString==Nil))
//                                                   {
//                                                       
//                                                       
//                                                       [self.myconnection deleteAdvanceTile:self.tileIdString];
//                                                   }
//                                                   
//                                                   //     [myappde.advanceTileIdDict removeObjectForKey:[NSString stringWithFormat:@"%d",selectedIndexValue]];
...
-(void)CreationoftileforUpdation:(NSInteger)count
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        for (int i=1; i<=1; i++) {
            ...
            UILabel *label1=[[UILabel alloc]initWithFrame:CGRectMake(15, 5, 400, 20)];
            label1.text= [NSString stringWithFormat:@"Carry forward all unused paid leaves to next year:"];
            [label1 setTextColor:[UIColor colorWithRed:88.0/255.0 green:89.0/255.0 blue:91.0/255.0 alpha:1.000]];
            label1.font = [UIFont fontWithName:@"Oxygen-Regular" size:13];
            [header1 addSubview:label1];
            [header1 setImage:[UIImage imageNamed:@"tab_plain.png"] forState:UIControlStateNormal];
            NSArray *array=[[NSBundle mainBundle]loadNibNamed:@"carryFirstView" owner:self options:nil];
        ...
        for (int i=2; i<=2; i++) {
            UIButton *header1 = [[UIButton alloc] initWithFrame:CGRectMake(0, 50, 0, 30)];
            UILabel *label1=[[UILabel alloc]initWithFrame:CGRectMake(15, 5, 550, 20)];
            label1.text= [NSString stringWithFormat:@"Carry forward certain %% of unused paid leaves to the next year (Say 50%%):"];
            [label1 setTextColor:[UIColor colorWithRed:88.0/255.0 green:89.0/255.0 blue:91.0/255.0 alpha:1.000]];
            label1.font = [UIFont fontWithName:@"Oxygen-Regular" size:13];
            [header1 addSubview:label1];
            [header1 setImage:[UIImage imageNamed:@"tab_plain.png"] forState:UIControlStateNormal];
            NSArray *array=[[NSBundle mainBundle]loadNibNamed:@"carrySecondView" owner:self options:nil];
            [self addHeader:header1 withView:[array objectAtIndex:0]];
            header1.tag=i-1;
        ...
        for (int i=3; i<=3; i++) {
            UIButton *header1 = [[UIButton alloc] initWithFrame:CGRectMake(0, 50, 0, 30)];
            UILabel *label1=[[UILabel alloc]initWithFrame:CGRectMake(15, 5, 550, 20)];
            label1.text= [NSString stringWithFormat:@"Repay remaining fully & half paid leaves at the end of the year and invalidate rest:"];
            [label1 setTextColor:[UIColor colorWithRed:88.0/255.0 green:89.0/255.0 blue:91.0/255.0 alpha:1.000]];
            label1.font = [UIFont fontWithName:@"Oxygen-Regular" size:13];
            [header1 addSubview:label1];
            [header1 setImage:[UIImage imageNamed:@"tab_plain.png"] forState:UIControlStateNormal];
            NSArray *array=[[NSBundle mainBundle]loadNibNamed:@"carryThirdView" owner:self options:nil];
            [self addHeader:header1 withView:[array objectAtIndex:0]];
            header1.tag=i-1;
        ...
        for (int i=4; i<=4; i++) {
            UIButton *header1 = [[UIButton alloc] initWithFrame:CGRectMake(0, 50, 0, 30)];
            UILabel *label1=[[UILabel alloc]initWithFrame:CGRectMake(15, 5, 550, 20)];
            label1.text= [NSString stringWithFormat:@"Repay certain  %% of fully & half paid leaves at the end of the year and invalidate rest(Say 50%%):"];
            [label1 setTextColor:[UIColor colorWithRed:88.0/255.0 green:89.0/255.0 blue:91.0/255.0 alpha:1.000]];
            label1.font = [UIFont fontWithName:@"Oxygen-Regular" size:13];
            [header1 addSubview:label1];
            [header1 setImage:[UIImage imageNamed:@"tab_plain.png"] forState:UIControlStateNormal];
            NSArray *array=[[NSBundle mainBundle]loadNibNamed:@"carryFourthView" owner:self options:nil];
            [self addHeader:header1 withView:[array objectAtIndex:0]];
            header1.tag=i-1;
        ...
        for (int i=5; i<=5; i++) {
            UIButton *header1 = [[UIButton alloc] initWithFrame:CGRectMake(0, 50, 0, 30)];
            UILabel *label1=[[UILabel alloc]initWithFrame:CGRectMake(15, 5, 550, 20)];
            label1.text= [NSString stringWithFormat:@"Invalidate all at the end of the year:"];
            [label1 setTextColor:[UIColor colorWithRed:88.0/255.0 green:89.0/255.0 blue:91.0/255.0 alpha:1.000]];
            label1.font = [UIFont fontWithName:@"Oxygen-Regular" size:13];
            [header1 addSubview:label1];
            [header1 setImage:[UIImage imageNamed:@"tab_plain.png"] forState:UIControlStateNormal];
            NSArray *array=[[NSBundle mainBundle]loadNibNamed:@"carryFifthView" owner:self options:nil];
            [self addHeader:header1 withView:[array objectAtIndex:0]];
            header1.tag=i-1;
