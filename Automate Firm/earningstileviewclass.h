...
@interface earningstileviewclass : UIView<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,headerprotocol>
{
    AppDelegate *app;
}
...
@property(nonatomic,retain) IBOutlet UITableView *paidbytableview;
...
@property(nonatomic,retain)IBOutlet UICollectionView *desigcollection;


@property(nonatomic,retain) IBOutlet UILabel *descriptionlabel;
@property(nonatomic,retain)NSMutableArray *paymentintervelarray;
@property(nonatomic,retain)NSMutableArray *paidbyarray;
...
@property(nonatomic,retain)NSMutableArray *designationAray;

@property(nonatomic,retain)NSMutableDictionary * firstDetailsDict;
@property(nonatomic,retain)NSMutableDictionary * tileDetailsDict;
...
@property(nonatomic,retain) IBOutlet UITextField *paidbytext;
...
@property(nonatomic,retain) IBOutlet UITextField *issue1PaymentText;
@property(nonatomic,retain) IBOutlet UITextField *hoursWorkedText;
@property(nonatomic,retain) IBOutlet UITextField *issueRateText;
...
@property(nonatomic,retain) IBOutlet UIView *issuefirstview;
...
@property(nonatomic,retain)IBOutlet UIView *considerView;
...
@property(nonatomic,retain)IBOutlet UILabel *nextPaymentLabel1;
...
@property(nonatomic,retain)IBOutlet UITextField *paidHolidayText;
@property(nonatomic,retain)IBOutlet UITextField *paidLeavesText;
...
@property(nonatomic,retain)NSString * earningflag;
@property(nonatomic,retain)NSString * accumalateFlag;
@property(nonatomic,retain)NSString * paidholiflag;
@property(nonatomic,retain)NSString * paidleaveflag;
@property(nonatomic,retain)NSString * switchString;


@property(nonatomic,retain)NSString * radioFlag1;
@property(nonatomic,retain)NSString * radioFlag2;
@property(nonatomic,retain)NSString *paymentintrvalTableString;
@property(nonatomic,retain)NSString *agetextTableString;
@property(nonatomic,retain)NSString *issuepaymentTableString;
@property(nonatomic,retain)NSString *issuepaymentTableString1;
@property(nonatomic,retain)NSString *houersworkedTableString;
@property(nonatomic,retain)NSString *houersworkedTableString1;
@property(nonatomic,retain)NSString *issuerateTableString;
@property(nonatomic,retain)NSString *paidbyTableString;
@property(nonatomic,retain)NSString *issueFlagString;
@property(nonatomic,retain)NSString *replaceStringFlag;
