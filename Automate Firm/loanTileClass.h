...
@optional
- (void)accordion:(loanTileClass *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface loanTileClass : UIView <UIScrollViewDelegate,headerprotocol> {
...
@property(nonatomic,assign)int usingdiscards;
...
@property(nonatomic,assign)CGPoint myoffset;
@end
