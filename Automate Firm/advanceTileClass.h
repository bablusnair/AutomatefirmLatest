...
@class advanceTileClass;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(advanceTileClass *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface advanceTileClass : UIView <UIScrollViewDelegate,headerprotocol> {
