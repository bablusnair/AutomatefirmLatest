...
- (IBAction)resendAction:(id)sender {
    ...
    if (self.x%2==0) {
        ...
        self.okButon.frame=CGRectMake(809, 319, 49, 30);
        self.resendButn.frame=CGRectMake(476, 319, 73, 21);
        ...
        self.okButon.frame=CGRectMake(809, 279, 49, 30);
        self.resendButn.frame=CGRectMake(476, 279, 73, 21);
