...
-(void)addaccordianview
{
    ...
    if (storevalue==flag-2) {
        ...
        label.text=[NSString stringWithFormat:@"Fine %d",flag];
        ...
        NSArray *array0=[[NSBundle mainBundle]loadNibNamed:@"fineSettingsInnerView" owner:self options:nil];
...
-(void)deletetile:(UILongPressGestureRecognizer *)sender
{
    if (headers.count > 1) {
        ...
        UIButton *closebutton = [[UIButton alloc] initWithFrame:CGRectMake(575, 8, 15, 15)];
