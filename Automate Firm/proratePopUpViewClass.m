...
#import "proratePopUpViewClass.h"

@implementation proratePopUpViewClass

-(void)awakeFromNib
{
    self.frame=CGRectMake(-60, 20, self.frame.size.width, self.frame.size.height);
