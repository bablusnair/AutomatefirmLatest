...
@optional
- (void)accordion:(expenseTile *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface expenseTile : UIView <UIScrollViewDelegate,headerprotocol> {
...
@property(nonatomic,assign)NSInteger storevalue;
