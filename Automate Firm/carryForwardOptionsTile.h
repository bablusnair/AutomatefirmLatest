...
@class carryForwardOptionsTile;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(carryForwardOptionsTile *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface carryForwardOptionsTile : UIView <UIScrollViewDelegate,headerprotocol> {
...
@property (nonatomic, strong) connectionclass *myconnection;
...
@property(nonatomic,assign)NSString *tileIdString;
