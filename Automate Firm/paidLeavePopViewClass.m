...
#import "paidLeavePopViewClass.h"

@implementation paidLeavePopViewClass

-(void)awakeFromNib
{
    self.frame=CGRectMake(-60,-90, self.frame.size.width, self.frame.size.height);
