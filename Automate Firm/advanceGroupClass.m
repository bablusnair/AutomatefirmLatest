...
{
    if ((textField==self.eligibilityText1) || (textField==self.conditionsText3)) {
    ...
    else if ((textField==self.eligibilityText3)||(textField==self.eligibilityText4)||(textField==self.conditionsText1))
    {
        if ([string isEqualToString:@""]) {
            return YES;
        }
...
{
    if (textField==self.eligibilityText1) {
        //self.text6=self.eligibilityText1.text;
        if (![self.eligibilityText1.text isEqualToString:@""]) {
            ...
            else
            {
             ...
             self.text1=self.eligibilityText1.text;
    ...
    else if (textField==self.eligibilityText3)
    {
        if (![self.eligibilityText3.text isEqualToString:@""]) {
             self.text2=self.eligibilityText3.text;
    ...
    else if (textField==self.eligibilityText4)
    {
        if (![self.eligibilityText4.text isEqualToString:@""]) {
            self.text3=self.eligibilityText4.text;
    ...
    else if (textField==self.conditionsText3)
    {
        if (![self.conditionsText3.text isEqualToString:@""]) {
            self.text4=self.conditionsText3.text;
    ...
    else if (textField==self.conditionsText1)
    {
        if (![self.conditionsText1.text isEqualToString:@""]) {
            self.text5=self.conditionsText1.text;
...
-(void)viewIndividualResponse:(id)responseList
{
   if ([responseList count]>0) {
    ...
    self.eligibilityText1.text=[[responseList objectAtIndex:0]objectForKey:@"gross_salary"];
    self.text1=[[responseList objectAtIndex:0]objectForKey:@"gross_salary"];
    ...
    self.eligibilityText2.text=[[responseList objectAtIndex:0]objectForKey:@"insatllment_limit"];
     ...
     if ([[responseList objectAtIndex:0]objectForKey:@"duration_of_visa"]!=(id)[NSNull null])
        {
            self.text2=[[responseList objectAtIndex:0]objectForKey:@"duration_of_visa"];
            self.eligibilityText3.text=[[responseList objectAtIndex:0]objectForKey:@"duration_of_visa"];
    }
    if ([[responseList objectAtIndex:0]objectForKey:@"eligible_for_advance"]!=(id)[NSNull null])
    {
        self.text3=[[responseList objectAtIndex:0]objectForKey:@"eligible_for_advance"];

        self.eligibilityText4.text=[[responseList objectAtIndex:0]objectForKey:@"eligible_for_advance"];
    }
    ...
    {
        self.text4=[[responseList objectAtIndex:0]objectForKey:@"next_leave_to_approve"];

    self.conditionsText1.text=[[responseList objectAtIndex:0]objectForKey:@"next_leave_to_approve"];
    }
    ...
    {
        self.text5=[[responseList objectAtIndex:0]objectForKey:@"last_working_day"];
         self.conditionsText3.text=[[responseList objectAtIndex:0]objectForKey:@"last_working_day"];
    }
