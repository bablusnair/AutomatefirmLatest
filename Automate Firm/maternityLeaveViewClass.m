...
@implementation maternityLeaveViewClass
@synthesize colour;
...
-(void)awakeFromNib
{
     ...
     [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadingthecollectionview) name:@"metenityleave" object:Nil];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  //  [cell1.stampicon1 setImage:[UIImage imageNamed:[self.stamparray1 objectAtIndex:indexPath.row]] forState:UIControlStateNormal];
    ...
    if ([[appDelegate.maternityleavearray objectAtIndex:indexPath.row]isKindOfClass:[UIImage class]]) {
        
        cell1.signImg.image=[appDelegate.maternityleavearray objectAtIndex:indexPath.row];
