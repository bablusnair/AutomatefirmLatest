...
@class IndividualAccordionView;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(IndividualAccordionView *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface IndividualAccordionView : UIView <UIScrollViewDelegate> {
