...
@class performanceEvaluationTile;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(performanceEvaluationTile *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface performanceEvaluationTile : UIView <UIScrollViewDelegate> {
