...
@class earningsAccordianview;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(earningsAccordianview *)accordion didChangeSelection:(NSIndexSet *)selection;


@end

@interface earningsAccordianview : UIView <UIScrollViewDelegate,headerprotocol> {
