...
@class autocodingTileClass;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(autocodingTileClass *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface autocodingTileClass : UIView <UIScrollViewDelegate,headerprotocol> {
